...
func init() {
	...
	var (
		...
		prefreg = regInfo{inputs: gponly, outputs: nil}
	)
	...
	var AMD64ops = []opData{
		...
		// Do prefetch arg0. arg0=addr, arg1=memory. Instruction variant selects locality hint
		{name: "PrefetchT0", argLength: 2, reg: prefreg, asm: "PREFETCHT0", hasSideEffects: true},
		{name: "PrefetchT1", argLength: 2, reg: prefreg, asm: "PREFETCHT1", hasSideEffects: true},
		{name: "PrefetchT2", argLength: 2, reg: prefreg, asm: "PREFETCHT2", hasSideEffects: true},
